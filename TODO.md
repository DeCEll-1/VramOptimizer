...
| [DDSCreator/Program.cs](DDSCreator/Program.cs#L29) | 29 | add a uhhh gpu check if the gpu allows dds textures |
| [DDSCreator/ConversionHandler/Converter.cs](DDSCreator/ConversionHandler/Converter.cs#L91) | 91 | create an error log |
...
| [UI/src/DeCell/UI/Backend/Components/Slider.java](UI/src/DeCell/UI/Backend/Components/Slider.java#L22) | 22 | make this height adjustable |
| [UI/src/DeCell/UI/Backend/Components/ColorPicker/ColorPickerV2.java](UI/src/DeCell/UI/Backend/Components/ColorPicker/ColorPickerV2.java#L62) | 62 | put a cursor on the color picker panel |
