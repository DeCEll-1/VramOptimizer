...
import DeCell.VOpt.UI.Backend.Components.Gears.UpDownArrow;
...
import static DeCell.VOpt.UI.Backend.DataPair.pair;
import static DeCell.VOpt.VOpt.Patterns.decimalWithMaxDecimalPlaces;
...
public class NumericUpDown extends UIContainer<NumericUpDown, UIComponentAPI> {
    ...
    public NumericUpDown(MyPanel _container, MyTextBox _tb, MyButton _up, MyButton _down) {
        ...
        tb.setValidationRegex(VOpt.Patterns.DECIMAL_ONLY);
